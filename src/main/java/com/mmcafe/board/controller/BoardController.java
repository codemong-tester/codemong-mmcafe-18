...
import org.springframework.http.HttpStatus;
    ...
    public class BoardController {
        ...
        public BoardResponse create(@RequestBody @Valid BoardRequest request) { return service.createBoard(request); }
        @GetMapping("/{id}")
        ...
        @PutMapping("/{id}")
        public BoardResponse update(@PathVariable long id, @RequestBody @Valid BoardRequest request) { return service.updateBoard(id, request); }
        @DeleteMapping("/{id}")
        ...
        @ResponseStatus(HttpStatus.CREATED)
        public CommentResponse createComment(@PathVariable long boardId, @RequestBody @Valid CommentRequest request) { return service.createComment(boardId, request); }
